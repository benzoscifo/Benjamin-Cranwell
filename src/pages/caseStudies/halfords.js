  ...
  return (
    <Layout>
      ...
      <section className="mt-14">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left self-center">
            <div className="pb-6"> 
              <a id="topOfPage" className="text-6xl font-serif font-extrabold">
              Next
              </a>
            </div>
            ...
            <p className="pb-4 text-lg">
              Why I chose this website. Opportunities 27.1 million visits on Desktop and Mobile from the last month. No 1 website in the Uk for Fashion and Apparel. The 10 images below will show good and bad practices with an explaination to why.
            </p>
            <h2 className="text-2xl font-semibold">The Methodology</h2>
            <p className="text-lg">
              Structure. Jakob Nielsen 10 general principles
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8">
            <h2 className="text-2xl font-semibold pb-6">2. Match between system and the real world</h2>
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8">
            <h2 className="text-2xl font-semibold pb-6">3. User control and freedom</h2>
            <p className="text-xl pb-1.5">
              The website should allow for the users to undo an action whether that is a mistake or because they have changed their mind. </p><p className="text-xl"> The Next website allows for this when wanting to remove an item from your basket. They have a clear edit button which gives the option to remove the item or save for later. 
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8">
            <h2 className="text-2xl font-semibold pb-6">4. Consistency and Standard</h2>
            <p className="text-xl pb-1.5">
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8">
            <h2 className="text-2xl font-semibold pb-6">5. Error Prevention</h2>
            <p className="text-xl pb-1.5">
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8">
            <h2 className="text-2xl font-semibold pb-6">6. Recognition rather than recall</h2>
            <p className="text-xl pb-1.5">
              Reducing the memory load of a user helps them complete their task quicker and reduces the chance of completion. 
            </p>
            <p className="text-xl">Next has a save for later option for items allowing the user to keep searching and using the app with the knowledge that they can always retrive their saved item whenever they need it.</p>
          </div>
        </div>
      </section>
      <section className="mt-10">
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8">
            <h2 className="text-2xl font-semibold pb-6">7. Flexibility and efficiency of use</h2>
            <p className="text-xl pb-1.5">
              Flexibility and efficiency can mean keyboard shortcuts or touch gestures to complete a task.
            </p>
            <p className="text-xl">Next has a well laid out page stucture with the correct labelling allowing for screen readers to navigate the page for accessiblity users.</p>
          </div>
        </div>
      </section>
      <section className="mt-10">
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8">
            <h2 className="text-2xl font-semibold pb-6">8. Aesthetic and Minimalist design</h2>
            <p className="text-xl pb-1.5">
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8">
            <h2 className="text-2xl font-semibold pb-6">9. Help users recognise, diagnose and recover from errors</h2>
            <p className="text-xl pb-1.5">
            ...
            <p className="text-xl">Next shows simple and clear error messages at the time of input allowing for correction before moving to the next input</p>
          </div>
        </div>
      </section>
      <section className="mt-10">
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8">
            <h2 className="text-2xl font-semibold pb-6">10. Help and Documentation</h2>
            <p className="text-xl pb-1.5">
