        ...
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left self-center">
            ...
            <p className="pb-4 text-base sm:text-xl">
              I chose the <b>Next</b> Fashion and Homeware website as it is the No 1. website in the UK for Fashion and Apparel.  With 27.1 million visits on Desktop and Mobile in Februray alone there is the possibility for small improvements to affect a large number of users. 
            </p>
            <h2 className="text-xl sm:text-2xl font-semibold">The Methodology</h2>
            <p className="text-base sm:text-xl">
              Using the <a href="https://www.nngroup.com/articles/ten-usability-heuristics/" target="blank" className="underline">Jakob Nielsen</a> 10 general principles laid out on their website I systematically worked through each principle testing it against the Next retail website. In my findings there where some good practices but also some bad practices.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left">
            ...
            <p className="text-base sm:text-xl pb-1.5">
              The system should always show the status of an on-going operation to the users until it is done, the Next checkout process doesn't do this.
            There is no clear signage to where they are in the process and how many steps are left to complete the task.</p><p className="text-base sm:text-xl"> Because the Next checkout process is done over several separate pages an improvement to the checkout process would be to have a progress tracker to visually show where in the process they are and how much is left to do.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left">
            ...
            <p className="text-base sm:text-xl">
              Next keeps consistency over its extensive catalogue of products and pages. And importantly they continue this consistancy to their mobile app. They also use the Standard iconography such as the menu and basket icons. 
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left">
            ...
            <p className="text-base sm:text-xl pb-1.5">
              Error prevention is the ability to prevent a problem occuring either by having a confirmation option or by giving a message to inform the user what they need to do e.g. minimum character for a password.
            </p>
            <p className="text-base sm:text-xl">
              Next does a very poor job in Error Prevention during the Sign Up process. As seen in the image below under the input box for password and email there is the format needed to prevent an error when signing up however is it extremely hard to read and easily missed.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left">
            ...
            <p className="text-base sm:text-xl pb-1.5">
              Reducing the memory load of a user helps them complete their task quicker and improves the chance of completion. 
            </p>
            <p className="text-base sm:text-xl">Next has a save for later option for product items allowing the user to keep searching and using the app with the knowledge that they can always retrive their saved item whenever they need it.</p>
          </div>
        </div>
      </section>
      <section className="mt-10">
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left">
            ...
            <p className="text-base sm:text-xl pb-1.5">
              Flexibility and efficiency can mean keyboard shortcuts, touch gestures to complete a task and also making the site easy to use for all types of users.
            </p>
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left">
            ...
            <p className="text-base sm:text-xl pb-1.5">
              Aesthetic and Minimalist design means having only relevant information for the user and avoid adding unnecessary content that doesn't add to user experience or task.
            </p>
            <p className="text-base sm:text-xl">
              On Next's mobile app Homepage they have designed the page to allow the user to navigate easily and seemlessly to differnet areas of their product catalogue.  
            </p>
          </div>
        </div>
      </section>
