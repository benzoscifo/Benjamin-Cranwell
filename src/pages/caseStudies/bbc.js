  ...
  return (
    <Layout>
      ...
      <section className="mt-8 sm:mt-14">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left self-center">
            <div className="pb-6"> 
              <a id="topOfPage" className="text-4xl sm:text-6xl text-bbc font-extrabold">
              BBC News
              </a>
            </div>
            ...
            <p className="text-base sm:text-xl">
              Usinging the Web Content Accessibility Guidelines(WCAG) I focused on 10 distinct areas that a website must have to have a good accessiblity rating.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left">
            <h2 className="text-xl sm:text-2xl font-semibold pb-6">4. No audio</h2>
            <p className="text-base sm:text-xl pb-1.5">
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left">
            <h2 className="text-xl sm:text-2xl font-semibold pb-6">5. Colour issues</h2>
            <p className="text-base sm:text-xl pb-1.5">
      ...
      <section className="mt-14 md:mt-20">
        <div className="flex flex-col md:flex-row mx-auto py-0 px-6 w-full max-w-screen-xl">
          <div className="p-8 text-center sm:text-left">
            <h2 className="text-xl sm:text-2xl font-semibold pb-6">6. Basic Structure Check</h2>
            <p className="text-base sm:text-xl pb-1.5">
